...
### Exercise 10 ###
# different methods to remove element(s) from a list
...
# The del keyword in Python removes an element or slice from a list.
numbers = [50, 60, 70, 80]
del numbers[1:2]
print(numbers) # [50, 70, 80]

# One other method from removing elements from a list is to take a slice of the list, which excludes the index or indexes of the item or items you are trying to remove. 
# For instance, to remove the first two items of a list, you can do
